            ...
            try {
                ...
                if (dis.get(p) < 0.02) {
                    ...
                    if (x == 1) {
                        ...
                        x = 2;
                        Toast.makeText(notifications_offline.this,"ชื่อป้ายรถประจำทางปัจจุบัน : " + NameBus.get(p), Toast.LENGTH_SHORT).show();
                        ...
                        Log.d("Test19", "p ==>" + p);
                        if (p < dis.size() - 1) {
                            Toast.makeText(notifications_offline.this,"ชื่อป้ายรถประจำทางถัดไป : " + NameBus.get(p + 1), Toast.LENGTH_SHORT).show();
                            Toast.makeText(notifications_offline.this,"จำนวนป้ายที่ผ่านอีก "+S+" ป้าย", Toast.LENGTH_SHORT).show();
                            gg4.setText("จำนวนป้ายที่ผ่านอีก "+S+" ป้าย");
